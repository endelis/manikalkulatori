...
const INFO_PAGE_UPDATED_AT: Record<string, string> = {
  '/sabiedriba/iedzivotaju-skaits-latvija': '2026-09-04T12:08:11+03:00',
};
...
const NOVADS_PILOT_UPDATED_AT: Record<string, string> = Object.fromEntries(
  NOVADS_PILOT_AREAS.map((area) => [`/sabiedriba/iedzivotaju-skaits/${area.slug}`, '2026-09-04T12:08:11+03:00']),
);
